                ...
                <div className="latest__list">
                    {
                        data.map(item => (
                            <div className="latest__item" key={item.id}>
                                <img src={item.urlImage} className="latest__image" />
                                ...
                                <div className="latest__price">
                                    { 
                                        item.salePrice > 0 ? (
                                            <>
                                                <span className="latest__price-present">${item.salePrice}</span>
                                                <span className="latest__price-origin">${item.originPirce}</span>
                                            </>
                                        ) : ( 
                                            <div className="latest__price-present">${item.originPirce}</div>
                                        )
                                    }
                                </div>
                            </div>
